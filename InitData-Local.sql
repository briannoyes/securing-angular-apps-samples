...
USE master
GO
if exists (select * from sysdatabases where name='ps_securing_angular_apps_api')
		drop database "ps_securing_angular_apps_api"
go
...
EXECUTE (N'CREATE DATABASE ps_securing_angular_apps_api
  ON PRIMARY (NAME = N''ps_securing_angular_apps_api'', FILENAME = N''' + @device_directory + N'ps_securing_angular_apps_api.mdf'')
  LOG ON (NAME = N''ps_securing_angular_apps_api_log'',  FILENAME = N''' + @device_directory + N'ps_securing_angular_apps_api.ldf'')')
go
...
EXECUTE (N'CREATE DATABASE ps_securing_angular_apps_sts
  ON PRIMARY (NAME = N''ps_securing_angular_apps_sts'', FILENAME = N''' + @device_directory + N'ps_securing_angular_apps_sts.mdf'')
  LOG ON (NAME = N''ps_securing_angular_apps_sts_log'',  FILENAME = N''' + @device_directory + N'ps_securing_angular_apps_sts.ldf'')')
go
...
USE [ps_securing_angular_apps_sts];
...
USE [ps_securing_angular_apps_api];
